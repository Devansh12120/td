                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="register-form">
                            <form name="sign" action="code.php" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" name="cpassword" type="text" placeholder="Password">
                                </div>
                                <div class="col-md-12">
                                    <button type="submit" name="signup_btn" class="btn">Submit</button>
                                </div>
                            </div>
                            </form>   
                        </div> 
                    ...
                    <div class="col-lg-6">
                        ...
                        ?> 
                                <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <button class="btn" name="login_btn">Submit</button>
                                        </div>
                                </div>
                            </form>
                        </div>
